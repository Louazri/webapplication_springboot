package com.louazri.webapplication.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.louazri.webapplication..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.louazri.webapplication..*.*(..))", throwing = "ex")
